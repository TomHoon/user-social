...
import SocialBridgePage from "./pages/auth/SocialBridgePage.jsx";
import KakaoLoginPage from "./pages/auth/KakaoLoginPage.jsx";
        ...
        <FavoritesProvider>
          <BookingProvider>
            <Routes>
              ...
              {/*kakao-3. 로그인페이지, 콜백페이지*/}
              <Route path="/social/kakao" element={<KakaoLoginPage />} />
              <Route path="/oauth/kakao/callback" element={<SocialBridgePage />} />
